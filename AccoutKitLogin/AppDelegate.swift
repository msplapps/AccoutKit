...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        //http://media.bemyapp.com/code-tutorial-accountkit-integration-swift-universal-app/
        
        //https://medium.com/@roHiguera/how-to-integrate-facebook-s-account-kit-quick-setup-swift-a1ed3cb42376
